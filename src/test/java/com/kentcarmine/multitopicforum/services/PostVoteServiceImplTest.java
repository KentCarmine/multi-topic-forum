...
class PostVoteServiceImplTest {
    ...
    void setUp() {
        ...
        postVoteService = new PostVoteServiceImpl(topicForumRepository, topicForumDtoToTopicForumConverter, topicThreadRepository, postRepository, postVoteRepository);
